...
Chip on the bar: now-playing, play/pause. Popup: skip, chill / flow / hype. Not a second Spotify client — it shells out to the `spotify` binary you already installed.
